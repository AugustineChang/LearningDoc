(function (global, factory) {
  ...
  var DEFAULT_CONFIG = Object.freeze({
	  ...
	  homeSpin: 0.0,     // starting spin in radians
  ...
  var Trackball = function Trackball(el, options) {
      ...
      this.currentSpin = this.config.homeSpin;
  ...
  Trackball.prototype.getMatrixZ = function getMatrix () {
  ...
  Trackball.prototype.getMatrixX = function getMatrix () {
      var r = this.getAngles();
      var spin = fromRotation$3(create$3(), r[0], [0, 1, 0]);
      var tilt = fromRotation$3(create$3(), r[1], [0, 0, 1]);
      return multiply$3(tilt, tilt, spin);
  };
