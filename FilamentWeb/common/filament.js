...
Filament.IcoSphere.prototype.subdivide = function() {
    ...
    for (let tri = 0; tri < nsrctris; tri++, i3 += 9, i4 += 9, i5 += 9) {
        ...
        glMatrix.vec3.normalize(v3, glMatrix.vec3.add(v3, v0, v1));
        glMatrix.vec3.normalize(v4, glMatrix.vec3.add(v4, v1, v2));
        glMatrix.vec3.normalize(v5, glMatrix.vec3.add(v5, v2, v0));
        dsttris[dstind++] = i0 / 3;
        dsttris[dstind++] = i3 / 3;
        dsttris[dstind++] = i5 / 3;
        dsttris[dstind++] = i3 / 3;
...
Filament.loadMathExtensions = function() {
    glMatrix.vec4.packSnorm16 = function(out, src) {
    ...
    const fromRotationZ = glMatrix.mat3.fromRotation;
    glMatrix.mat3.fromRotation = function(out, radians, axis) {
        if (axis) {
            return glMatrix.mat3.fromMat4(out, glMatrix.mat4.fromRotation(glMatrix.mat4.create(), radians, axis));
        }
